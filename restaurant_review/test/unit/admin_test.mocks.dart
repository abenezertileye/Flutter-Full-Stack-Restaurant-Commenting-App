...
// in restaurant_review/test/unit/admin_test.dart.
...
import 'package:restaurant_review/data/storage.dart' as _i3;
...
class MockSecureStorage extends _i1.Mock implements _i3.SecureStorage {
  ...
  @override
  _i4.Future<String?> read(dynamic key) => (super.noSuchMethod(
        Invocation.method(
          #read,
          [key],
        ),
